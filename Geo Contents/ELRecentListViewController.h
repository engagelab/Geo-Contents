 ...
 *
 *  Discussion:
 *      Display geo-features in chronological order added nearby to user current location in a list view which is vertically scrollable. It is based on the UICollectionView Controller.
 *  Main Functions:
 *      1 - display POIs in list view in chronological order near to user location
