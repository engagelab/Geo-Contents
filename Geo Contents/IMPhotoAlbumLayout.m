...
static NSString * const IMPhotoAlbumLayoutPhotoCellKind = @"PhotoCell";

@interface IMPhotoAlbumLayout()
...
@implementation IMPhotoAlbumLayout
...
- (void)prepareLayout
{
    ...
    newLayoutInfo[IMPhotoAlbumLayoutPhotoCellKind] = cellLayoutInfo;
...
{
    return self.layoutInfo[IMPhotoAlbumLayoutPhotoCellKind][indexPath];
}
